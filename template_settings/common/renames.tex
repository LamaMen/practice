\newcommand{\Author}{И.А.\,Родионов} % И.О. Фамилия автора 
\newcommand{\AuthorFull}{Родионов Илья Алексеевич} % Фамилия Имя Отчество автора
\newcommand{\AuthorFullDat}{Родионову Илья Алексеевичу} % Фамилия Имя Отчество автора в дательном падеже (Кому? Студенту...)
\newcommand{\AuthorFullVin}{Родионова Ильи Алексеевича} % в винительном падеже (Кого? что?  Програмиста ...)
\newcommand{\AuthorPhone}{+7-911-376-42-56} % номер телефорна автора для оперативной связи  
\newcommand{\Supervisor}{Туральчук К.А} % И. О. Фамилия научного руководителя
\newcommand{\SupervisorFull}{Туральчук Константин Анатольевич} % Фамилия Имя Отчество научного руководителя
...
\newcommand{\Head}{Карпушин В.Б.} % И. О. Фамилия руководителя подразделения (руководителя ОП)
\newcommand{\HeadFull}{Карпушин Василий Борисович} % И. О. Фамилия руководителя подразделения (руководителя ОП)
\newcommand{\HeadDegree}{технический директор Rem\&Coil}% Только должность:   
%Руководитель %ОП 
%Заведующий % кафедрой
...
\newcommand{\ConsultantExtra}{Пархоменко В.А.} % И. О. Фамилия дополнительного консультанта 
...
%%
%%
\newcommand{\group}{3530903/90301} % заменить вместо N номер группы
...
\newcommand{\PracticeType}{Отчет о прохождении производственной технологической (проектно-технологической) практики}

\newcommand{\Workplace}{СПбПУ, ИКНТ, ВШИСиСТ}
...
\newcommand{\practiceTitle}{Разработка системы учета рабочего времени для сотрудников}
